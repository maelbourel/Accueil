...
Wazuh fournit un script d'installation tout en un qui déploie les trois composants sur la même VM : 
...
```bash 
INFO: --- Summary ---
INFO: You can access the web interface https://<IP_SERVEUR>:443
    User: admin
